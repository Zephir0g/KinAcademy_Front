...
import com.Zephir0g.kinacademy.dto.CategoryDTO;
...
import com.Zephir0g.kinacademy.entity.data.mappers.CourseMapper;
import com.Zephir0g.kinacademy.entity.data.mappers.SectionMapper;
import com.Zephir0g.kinacademy.entity.data.mappers.VideoMapper;
import com.Zephir0g.kinacademy.entity.data.repository.CourseRepository;
...
public class CourseService {
    ...
    public CourseDto createCourse(SingUpCourseDto singUpCourseDto, String username) {
        ...
        Response joinCourse = joinCourse(username, course.getUrl());
        System.out.println("Join course response " + joinCourse);
